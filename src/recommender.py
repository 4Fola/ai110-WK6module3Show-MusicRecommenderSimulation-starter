...
def score_song(
    ...
    # Weight presets (Strategy-like) [Doc §Optional – Challenge 2]
    if mode == "genre_first":
    ...
    # Mood tag overlaps (optional) [Doc §Optional – Challenge 1]
    ...
    # Popularity (mild boost) [Doc §Optional – Challenge 1]
...
def recommend_songs(
    ...
    # Apply diversity penalty greedily [Doc §Optional – Challenge 3]
    taken: List[Dict] = []
